    ...
    test('test putItem()', function(t) {
        ...
        db.putItem('chilts', timestamp1, item, function(err) {
            ...
            db.getItem('chilts', function(err, changeset) {
                ...
                t.equal(changeset.hash, 'dbdbab3832f5594e33ded7e286551518', 'flatten-unchanged: (1) The last hash of this item should be this');
    ...
    test('test put()', function(t) {
        db.set('chilts', timestamp2, { logins : 10 }, function(err) {
            ...
            db.getItem('chilts', function(err, changeset) {
                ...
                // test that we know what the hash is of
                t.equal(changeset.hash, '897547f3b4f8f6e09785a8aa3e79e32d', 'flatten-unchanged: (2) The last hash of this item should be this');
